...
function DataBindingAxiosExample()
{
const [product, setProduct] = useState({ title: '', price: 0, image: '', rating: { rate: 0, ratings: 0, reviews: 0 }, offers: [] });
const [styleObj]=useState({color:'teal',fontWeight:'bold',fontSize:'50px',textAlign:'center'});
    function GetProduct() {
    ...
    setProduct(response.data);
        ...
        <div className="container-fluid">
            <h1 style={styleObj}>Product Details</h1>
...
export default DataBindingAxiosExample;